...
public class EdgeTester {
	...
	@Test
	void failedEqualsTestUser() {
		assertFalse(edgeTest.equals(new Edge(new User(), v_to, 1)));
	}

	@Test
	void successHashCode() {
		assertEquals(u_from.hashCode(), edgeTest.hashCode());
	}

	@Test
	void failedHashCode() {
		assertNotEquals(v_to.hashCode(), edgeTest.hashCode());
	}
}
