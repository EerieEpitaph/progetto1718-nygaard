...
//Verrà testato il parsing e l'interpretazione degli argomenti,
...
public class ParserInterpreterTest {
	...
	void helpCalled() throws ZipException, IOException {
		...
		// Eseguendo l'interprete, la stampa a video verrà rediretta
		...
		// In questo caso l'help "stamperà" nel secondo nostro stream
		dataCtr.showHelp();
		...
		// Se la stampa con argomenti "help" è infatti la funzione dataCtr.help(),
